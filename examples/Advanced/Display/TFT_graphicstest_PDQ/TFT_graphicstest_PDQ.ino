...
void loop(void)
{
	...
	uint16_t c = 4;
	int8_t d = 1;
	for (int32_t i = 0; i < MA.Lcd.height(); i++)
	{
		MA.Lcd.drawFastHLine(0, i, MA.Lcd.width(), c);
		c += d;
		if (c <= 4 || c >= 11)
			d = -d;
	}
	...
	MA.Lcd.setTextSize(1);
	MA.Lcd.println(F(""));
	MA.Lcd.setTextColor(MA.Lcd.color565(0x80, 0x80, 0x80));

	// MA.Lcd.println(F(""));


	MA.Lcd.setTextColor(TFT_GREEN);
	MA.Lcd.println(F(" Benchmark               microseconds"));
	MA.Lcd.println(F(""));
	MA.Lcd.setTextColor(TFT_YELLOW);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("HaD pushColor      "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecHaD);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Screen fill        "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	...
	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Pixels             "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecPixels);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Lines              "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecLines);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Horiz/Vert Lines   "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecFastLines);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Rectangles         "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecRects);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Rectangles-filled  "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecFilledRects);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Circles            "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecCircles);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Circles-filled     "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecFilledCircles);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Triangles          "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecTriangles);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Triangles-filled   "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecFilledTrangles);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Rounded rects      "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usecRoundRects);

	MA.Lcd.setTextColor(TFT_CYAN); MA.Lcd.setTextSize(1);
	MA.Lcd.print(F("Rounded rects-fill "));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	printnice(usedFilledRoundRects);

	MA.Lcd.setTextSize(1);
	MA.Lcd.println(F(""));
	MA.Lcd.setTextColor(TFT_GREEN); MA.Lcd.setTextSize(2);
	MA.Lcd.print(F("Benchmark Complete!"));
...
uint32_t testHaD()
{
	...
	{
		MA.Lcd.setAddrWindow(0, 0, 240, 320);

		uint16_t cnt = 0;
		uint16_t color = MA.Lcd.color565((i << 4) | i, (i << 4) | i, (i << 4) | i);
		uint16_t curcolor = 0;
		...
		while (cmp < &HaD_240x320[sizeof(HaD_240x320)])
		{
			...
			MA.Lcd.pushColor(curcolor, cnt);	// PDQ_GFX has count
			curcolor ^= color;
		}
	}
	...
	MA.Lcd.setTextColor(TFT_YELLOW);
	MA.Lcd.setTextSize(2);
	MA.Lcd.setCursor(8, 285);
	MA.Lcd.print(F("http://hackaday.io/"));
	MA.Lcd.setCursor(96, 302);
	MA.Lcd.print(F("Xark"));
...
uint32_t testText()
{
	...
	uint32_t start = micros_start();
	MA.Lcd.setCursor(0, 0);
	MA.Lcd.setTextColor(TFT_WHITE,TFT_BLACK);	MA.Lcd.setTextSize(1);
	MA.Lcd.println(F("Hello World!"));
	MA.Lcd.setTextSize(2);
	MA.Lcd.setTextColor(MA.Lcd.color565(0xff, 0x00, 0x00));
	MA.Lcd.print(F("TFT_RED "));
	MA.Lcd.setTextColor(MA.Lcd.color565(0x00, 0xff, 0x00));
	MA.Lcd.print(F("TFT_GREEN "));
	MA.Lcd.setTextColor(MA.Lcd.color565(0x00, 0x00, 0xff));
	MA.Lcd.println(F("TFT_BLUE"));
	MA.Lcd.setTextColor(TFT_YELLOW); MA.Lcd.setTextSize(2);
	...
	MA.Lcd.println(F("Groop"));
	MA.Lcd.setTextSize(2);
	MA.Lcd.println(F("I implore thee,"));
  MA.Lcd.setTextColor(TFT_GREEN);
	MA.Lcd.setTextSize(1);
	MA.Lcd.println(F("my foonting turlingdromes."));
	MA.Lcd.println(F("And hooptiously drangle me"));
	MA.Lcd.println(F("with crinkly bindlewurdles,"));
	MA.Lcd.println(F("Or I will rend thee"));
	MA.Lcd.println(F("in the gobberwarts"));
	MA.Lcd.println(F("with my blurglecruncheon,"));
	MA.Lcd.println(F("see if I don't!"));
	MA.Lcd.println(F(""));
	MA.Lcd.println(F(""));
	MA.Lcd.setTextColor(TFT_MAGENTA);
	MA.Lcd.setTextSize(6);
	MA.Lcd.println(F("Woot!"));
	uint32_t t = micros() - start;
	delay(1000);
	return t;
}
...
uint32_t testPixels()
{
	int32_t	w = MA.Lcd.width();
	int32_t	h = MA.Lcd.height();
	...
	for (uint16_t y = 0; y < h; y++)
	{
		...
		{
			MA.Lcd.drawPixel(x, y, MA.Lcd.color565(x<<3, y<<3, x*y));
		}
	}
...
uint32_t testRects(uint16_t color)
{
	uint32_t start;
	int32_t n, i, i2;
	int32_t cx = MA.Lcd.width() / 2;
	int32_t cy = MA.Lcd.height() / 2;
...
uint32_t testFilledRects(uint16_t color1, uint16_t color2)
{
	uint32_t start, t = 0;
	int32_t n, i, i2;
	int32_t cx = MA.Lcd.width() / 2 - 1;
	int32_t cy = MA.Lcd.height() / 2 - 1;
...
{
	uint32_t start;
	int32_t x, y, w = MA.Lcd.width(), h = MA.Lcd.height(), r2 = radius * 2;
...
uint32_t testCircles(uint8_t radius, uint16_t color)
{
	...
	int32_t w = MA.Lcd.width() + radius;
	int32_t h = MA.Lcd.height() + radius;
