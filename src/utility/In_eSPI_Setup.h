  ...
  #define TFT_CS          36UL  // Chip select control pin
  #define TFT_RST         37UL  // Reset pin
  #define TFT_DC          38UL  // Data Command control pin
  #define TFT_WR          39UL  // Write strobe control pin
