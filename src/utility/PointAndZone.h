...
== The PointAndZone Library ==
  ...
  MaixDisplay and MaixButton, libraries originally written for the M5Stack series
...
== Looking for Directions? ==
  ...
  MaixButton highler level library. Its 'Event' objects have methods that look
...
== Screen Rotation and the 'rot1' Property ==
  ...
  The TFT_eSPI library allows you to rotate the screen. On Maix devices,
  you do this with "MA.Lcd.SetRotation", supplying a number between 0 and 7.
  ...
  The MaixTouch library for the Amigo device rotates the data it reads from the
  ...
  the same place even if the screen is rotated. On the Amigo, this is used to
...
== Porting ==
  ...
  To use this library on other devices, simply replace these two lines
    ...
    #include <MaixDisplay.h>        // so that we can get the rotation
